...
- Posts in the current weekly Top 7 receive a server-rendered, accessible 🔥 marker immediately before the Seen eye on feeds, archives, and single-post action rows.
